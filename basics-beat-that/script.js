// // // Assigning variable to store scores
...
// //     }
// //     let Dice1 = player1Roll[0];
// //     let Dice2 = player1Roll[1];
...
// //       return `Player 1, you chose Dice 1 first. Your number is ${player1num}. It is now Player 2's turn.`;
// //     } else {
// //       player1num = player1Roll[1] * 10 + player1Roll[0];
// //       gameState = "Player 2 roll";
// //       console.log("end of player 1 choice - 2");
// //       return `Player 1, you chose Dice 2 first. Your number is ${player1num}. It is now Player 2's turn.`;
// //     }
// //   }
...
// //     }
// //     let Dice1 = player2Roll[0];
// //     let Dice2 = player2Roll[1];
// //     gameState = "Player 2 choice";

// //     return `Welcome Player 2. You rolled ${Dice1} for Dice 1 and ${Dice2} for Dice 2. Choose the order of the dice by entering 1 or 2.`;
// //   }
...
// //       return `Player 2, you chose Dice 1 first. Your number is ${player2num}. Let's compare!`;
// //     }
// //     if (player2Choice == 2) {
// //       player2num = player2Roll[1] * 10 + player2Roll[0];
// //       gameState = "Comparison";
// //       return `Player 2, you chose Dice 2 first. Your number is Your number is ${player2num}. Let's compare!`;
// //     }
// //   }
...
// //       return `Player 1: ${player1num}<br>Player 2: ${player2num}<br><br>Player 1 wins! Player 1 can start to play again!`;
// //     } else {
// //       gameState = "Player 1 roll";
// //       return `Player 1: ${player1num}<br>Player 2: ${player2num}<br><br>Player 2 wins! Player 1 can start to play again!`;
// //     }
// //   }
// // };
...
//       player2num = player2Roll[1] * 10 + player2Roll[0];
//       gameState = "Comparison";
//       return `Player 2, you chose Dice 2 first. Your number is ${player2num}. Let's compare!`;
//     }
//   }
...
//     }
//   }
//   let order = [...leaderboard].sort((a, b) => b.score - a.score);
//   console.log(order);
//   console.log(leaderboard);

//   if (player1Score > player2Score) {
//     console.log("player 1 winning");
//     statement = "Player 1 is leading! Current scores are: ";
//   }

//   if (player1Score < player2Score) {
//     console.log("player 2 winning");
//     statement = "Player 2 is leading! Current scores are: ";
//   }

//   player1Win = `Player 1: ${player1num}<br>Player 2: ${player2num}<br><br>Player 1 wins! Player 1 can start to play again!<br><br>${statement}<br>${order}`;

//   player2Win = `Player 1: ${player1num}<br>Player 2: ${player2num}<br><br>Player 2 wins! Player 1 can start to play again!<br><br>${statement}<br>${order}`;

//   if (roundResults == "Player 1 wins") {
//     myOutputValue = player1Win;
//     roundResults = "";
//     return myOutputValue;
//   }
//   if (roundResults == "Player 2 wins") {
//     myOutputValue = player2Win;
//     roundResults = "";
//     return myOutputValue;
//   }
// };
